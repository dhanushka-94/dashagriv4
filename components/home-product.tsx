      ...
      <section className="border-t border-coco-sand bg-white py-14 sm:py-20">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div>
              ...
              <dl className="mt-6 divide-y divide-coco-sand rounded-2xl border border-coco-sand bg-coco-cream/30">
                {PRODUCT.specs.map((spec) => (
                  <div
                    key={spec.label}
                    className="grid gap-1 px-5 py-4 sm:grid-cols-[9rem_1fr] sm:gap-4 sm:px-6"
                  >
          ...
          <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <QuoteButton className="inline-flex min-h-12 items-center justify-center rounded-full bg-coco-husk px-8 text-base font-semibold text-white shadow-md transition hover:bg-coco-husk-deep">
              Get a quote
            </QuoteButton>
            <a
              href="#how-to-use"
              className="inline-flex min-h-12 items-center justify-center rounded-full border-2 border-coco-husk/25 px-8 text-base font-semibold text-coco-husk transition hover:border-coco-husk/50 hover:bg-coco-leaf-light/50"
            >
              How to use
            </a>
          </div>
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border border-coco-sand bg-coco-leaf-light/80 p-5 shadow-sm sm:col-span-2 lg:col-span-1">
          ...
          <div className="mt-8 flex justify-center">
            <QuoteButton className="inline-flex min-h-12 items-center justify-center rounded-full bg-coco-husk px-10 text-base font-semibold text-white shadow-lg transition hover:bg-coco-husk-deep">
